...
const Signup = () => {
  ...
  const { login } = useAuth(); // You'll need to import useAuth
  const navigate = useNavigate(); // You'll need to import useNavigate
  ...
  const handleSubmit = (e) => {
    ...
    try {
      ...
      login(formData, 'local-signup-token');
      navigate('/Dashboard');
    } catch {
  ...
  // ✅ Google Signup Success - ORIGINAL FUNCTIONALITY
  const handleGoogleSuccess = (credentialResponse) => {
    try {
      const decoded = jwtDecode(credentialResponse.credential); // You'll need to import jwtDecode
      const userData = {
        email: decoded.email,
        name: decoded.name,
  ...
  // ❌ Google Signup Error - ORIGINAL FUNCTIONALITY
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      {/* Left Side - Blue Section (stacked on mobile) */}
      <div className="w-full lg:w-1/2 bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 relative overflow-hidden flex items-center justify-center p-8 lg:p-12">
        ...
        <div className="absolute inset-0">
          ...
          {/* Floating icons with custom animation */}
          <div 
  ...
  <div className="w-full lg:w-1/2 bg-gray-50 flex items-center justify-center p-6 md:p-8">
        <div className="w-full max-w-md">
          ...
          {/* Error Alert - ORIGINAL FUNCTIONALITY */}
          {error && (
          ...
          {/* ORIGINAL Google Login Component */}
          ...
          {/* ORIGINAL Form - UNCHANGED FUNCTIONALITY */}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors outline-none"
                  />
                </div>
              </div>
          ...
          {/* ORIGINAL Login Link - Using Link component as in your original */}
