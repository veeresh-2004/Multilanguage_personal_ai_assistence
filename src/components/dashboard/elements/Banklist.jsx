...
const PersonalLoansDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
      {/* Header */}
      <div className="bg-white/90 backdrop-blur-md border-b border-white/20 sticky top-0 z-10 shadow-lg">
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-6">
              <button onClick={handleBack}
                className="flex items-center text-gray-600 hover:text-gray-800 transition-colors duration-300 bg-gray-100 hover:bg-gray-200 px-4 py-2 rounded-xl"
              >
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-lg">Compare personal loan offers across major banks</p>
                </div>
              </div>
            </div>
            
            <div className="text-sm text-gray-500 bg-white/80 px-4 py-3 rounded-xl shadow-sm">
              <div className="flex items-center space-x-2">
                <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                <span>Live Offers • {loanData.length} Banks</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all text-lg"
              />
            </div>
            ...
            <div className="flex flex-wrap gap-4">
              <select
                ...
                className="px-6 py-4 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-green-500 focus:border-transparent text-lg"
              >
              ...
              <button
                ...
                className="px-6 py-4 bg-gradient-to-r from-green-600 to-blue-600 text-white rounded-2xl hover:from-green-700 hover:to-blue-700 transition-all flex items-center space-x-2 shadow-lg"
              >
